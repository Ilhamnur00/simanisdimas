...
class ResetPassword extends Notification
{
    ...
    protected function buildMailMessage($url)
    {
        return (new MailMessage)
            ...
            ->line(Lang::get('Jika Anda tidak meminta reset, abaikan email ini.'));
    }
